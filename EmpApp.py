...
def addJob():
    try:
        ...
        try:
            cursor.execute(insert_sql, (job_id, publish_date, job_type, job_position, job_description, job_requirement, job_location, job_salary, job_openings, job_industry, int(company),))
            db_conn.commit()    
        except Exception as e:
                print(str(e))
    finally:
